...
public class VectorTest {
	...
	public static void main(String[] args) {
		 ...
		 *  	그래서, int는 Interger, boolean은 Boolean, char은 Character등으로 대체해서
		 *  	사용해야 한다.
		...
		v2.add("안녕하세요");
//		v2.add(123);	//오루 : 제네릭타입과 다른 종류의 데이터를 저장할 수 없다.
		...
		// ==> 'Collection객체'가 가지고 있는 데이터를 Vector에서 모두 삭제한다.
